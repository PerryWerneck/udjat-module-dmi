#
# spec file for package udjat-module-dmi
#
...
BuildRequires:  dmiget-devel

Provides:		udjat-module-protocol-dmi
Conflicts:		otherproviders(udjat-module-protocol-dmi)

%description
UDJat DMI library

DMI Access module for %{product_name}.
